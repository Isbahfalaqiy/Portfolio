...
const ContentAbout = () => {
	...
	return (
		<div className="mt-32">
			<div className="px-5 md:px-16 lg:px-20 w-full">
				<div className="container bg-green-500 rounded-[20px] ">
					{/* Header section with title and line */}
					<div className="flex items-center w-[310px] md:w-[345px] lg:w-[475px] mt-10 pt-10" data-aos="fade-down" data-aos-duration="100">
					...
					<div className="flex flex-col md:flex-row items-center pb-10" >
						{/* Image on the left */}
						<div className="w-full md:w-1/2 flex justify-center mt-5 lg:w-1/3" data-aos="fade-up"  >
							<img
								src={img1}
						...
						<div className="w-full md:w-2/3 text-white px-5 md:pl-20 text-justify mt-5 md:mt-0">
							<p className="mb-10 leading-relaxed font-popins font-normal text-[20px] indent-12" data-aos="fade-down-left" data-aos-duration="100" data-aos-delay="100" >
							...
							<p className="leading-relaxed font-popins font-normal text-[20px] indent-12" data-aos="fade-up-left" data-aos-duration="200" data-aos-delay="200">
