  ...
  return (
    <div className="fixed top-0 w-full z-50 shadow-lg bg-white text-black">
      ...
      <div className="hidden lg:flex justify-between px-8 lg:px-20 py-8 items-center">
        <div className="logo sm:text-[15px] lg:text-[20px] font-Poppins font-semibold cursor-pointer hover:text-[#C5D86D]">IsbahFalaqiy.log();</div>
        <ul className="flex gap-8 mr-[3px] list-none font-Poppins font-semibold text-[15px] items-center">
          <li>
            <Link
              to="/"
        ...
        <a href="https://github.com/Isbahfalaqiy" target="_blank" rel="noopener noreferrer">
          <FaGithub className="text-3xl hover:text-[#C5D86D] ml-1 flex justify-end" />
        </a>
      </div>
      ...
      <div className="lg:hidden flex justify-between px-8 py-8 items-center">
        ...
        <div onClick={toggleMenu}>
          {isMenuOpen ? <AiOutlineClose className="text-3xl cursor-pointer" /> : <AiOutlineMenu className="text-3xl cursor-pointer" />}
        </div>
      </div>
